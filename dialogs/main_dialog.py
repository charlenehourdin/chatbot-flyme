...
class MainDialog(ComponentDialog):
    ...
    async def intro_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        message_text = (
            ...
            else "Hello, What can i do for you ?"
        )
    ...
    def create_adaptive_card_attachment(self, result):
        ...
        start_travel_date = result.start_travel_date
        end_travel_date = result.end_travel_date
        budget = result.budget

        templateCard = {
            "origin": origin, 
            "destination": destination,
            "start_date": start_travel_date,
            "end_date": end_travel_date,
            "budget": budget}
